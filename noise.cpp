...
void AccidentalNoise::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("fractal_layer", "basis_type", "interp_type_index",
                                  ...
                                  "angle", "ax", "ay", "az"),&AccidentalNoise::fractal_layer, DEFVAL(true), DEFVAL(0.5), DEFVAL(0.0), DEFVAL(0.0), DEFVAL(1.0));

    ClassDB::bind_method(D_METHOD("ridged_layer", "basis_type", "interp_type_index",
                                  "scale", "frequency", "seed", "rotation",
                                  "angle", "ax", "ay", "az"),&AccidentalNoise::ridged_layer, DEFVAL(true), DEFVAL(0.5), DEFVAL(0.0), DEFVAL(0.0), DEFVAL(1.0));

    ClassDB::bind_method(D_METHOD("billow_layer", "basis_type", "interp_type_index",
                                   "scale", "frequency", "seed", "rotation",
                                  "angle", "ax", "ay", "az"),&AccidentalNoise::billow_layer, DEFVAL(true), DEFVAL(0.5), DEFVAL(0.0), DEFVAL(0.0), DEFVAL(1.0));

    ClassDB::bind_method(D_METHOD("fbm", "basis_type", "interp_type",
                                  "numoctaves", "frequency", "seed", "rotation"),&AccidentalNoise::fbm, DEFVAL(true));

    ClassDB::bind_method(D_METHOD("ridged_multifractal", "basis_type", "interp_type",
                                  "numoctaves", "frequency", "seed", "rotation"),&AccidentalNoise::ridged_multifractal, DEFVAL(true));
